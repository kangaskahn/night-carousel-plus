...
function ocp_OwlCarouselSlideCarousel_add_new_meta_field() {
	...
	<div class="form-field">
		<label for="term_meta[custom_options]"><?php _e( 'Carousel Options', 'owl-carousel-plus' ); ?></label>
		<textarea type="text" name="term_meta[custom_options]" id="term_meta[custom_options]" rows="20" cols="40">
loop:true,
    margin:10,
...
function ocp_OwlCarouselSlideCarousel_edit_meta_field($term) {
	...
	<tr class="form-field">
	<th scope="row" valign="top"><label for="term_meta[custom_options]"><?php _e( 'Carousel Options', 'owl-carousel-plus' ); ?></label></th>
		<td>
			<textarea type="text" name="term_meta[custom_options]" id="term_meta[custom_options]" rows="20" cols="40">
<?php echo esc_attr( $term_meta['custom_options'] ) ? esc_attr( $term_meta['custom_options'] ) : ''; ?>
			</textarea>
			<p class="description"><?php _e( 'Enter options or leave it blank. Default options have been provided. <a href="https://owlcarousel2.github.io/OwlCarousel2/docs/api-options.html" target="_blank">Use this list to explore more carousel options</a>.','owl-carousel-plus' ); ?></p>
		</td>
	</tr>
